...
#| eval: false
census_api_key <- readLines("~/Documents/GitHub/stat212/portfolio-cluno113/src/ica/census_api_key.txt")
```
...
resp_pt$response$docs$headline
```
...
page <- url |> read_html()
# use selector chrome extension to find
content <- page |> 
